...
public class RoleController extends BaseController {
    ...
    @HasAnyPermission(permissionCode = {
            PermissionEnums.ADMIN_ROLE_LIST,
            PermissionEnums.ADMIN_ROLE_MODIFY
    })
    ...
    @GetMapping(value = "/detail/{roleId}", produces = APPLICATION_JSON_VALUE)
    public ApiResp<RoleVO> roleDetail(@PathVariable("roleId") Long roleId) {
